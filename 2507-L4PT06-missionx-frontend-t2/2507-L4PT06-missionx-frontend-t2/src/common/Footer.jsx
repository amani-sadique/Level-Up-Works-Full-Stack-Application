    ...
    return(
        <div className={`${styles.footer}`}>
            ...
            <div>
                ...
                <p>LevelUp Works is an Auckland-based Enterprise dedicated to developing game-based learning software to hlp teachers in response to the New Zealand Digital Technologies & Hangarau Matihiko.</p>
